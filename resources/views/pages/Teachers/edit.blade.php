...
@section('css')
    @toastr_css
@section('title')
    {{ trans('general.technoSoft') }} | {{ trans('teachers.Edit_Teacher') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0">{{ trans('teachers.Edit_Teacher_Information') }}</h4>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                    ...
                    <li class="breadcrumb-item active">{{ trans('teachers.Edit_Teacher') }}</li>
                </ol>
            </div>
        </div>
    </div>
                            ...
                            <form action="{{route('Teachers.update','test')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <img id="previewImg" src="{{ asset('uploads/teacher/avatar') }}/{{ $Teachers->Photo }}" class="rounded-circle pull-left" style="max-width: 250px; margin-left: 150px;">
                                        @error('photo')
                                ...
                                <div class="form-row">
                                    <div class="col">
                                        ...
                                        <input type="email" value="{{$Teachers->Email}}" name="Email" class="form-control">
                                        @error('Email')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" name="Mobile" value="{{ $Teachers->Mobile }}" class="form-control">
                                        @error('Mobile')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class='input-group date'>
                                            <input class="form-control" value="{{$Teachers->Joining_Date}}" type="text"  id="datepicker-action" name="Joining_Date" data-date-format="yyyy-mm-dd"  required>
                                        </div>
                                        @error('Joining_Date')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
